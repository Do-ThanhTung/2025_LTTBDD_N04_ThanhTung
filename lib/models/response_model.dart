...
class ResponseModel {
  ...
  factory ResponseModel.fromJson(Map<String, dynamic> json) {
    return ResponseModel(
      ...
      phonetics: (json['phonetics'] as List<dynamic>?)
          ?.map((e) => Phonetics.fromJson(Map<String, dynamic>.from(e)))
          .toList(),
      meanings: (json['meanings'] as List<dynamic>?)
          ?.map((e) => Meanings.fromJson(Map<String, dynamic>.from(e)))
          .toList(),
  ...
  Map<String, dynamic> toJson() => {
        ...
        if (sourceUrls != null) 'sourceUrls': sourceUrls,
      };
}
...
class Phonetics {
  ...
  const Phonetics({this.text, this.audio, this.sourceUrl});
...
class Meanings {
  ...
  factory Meanings.fromJson(Map<String, dynamic> json) => Meanings(
        ...
        definitions: (json['definitions'] as List<dynamic>?)
            ?.map((e) => Definitions.fromJson(Map<String, dynamic>.from(e)))
            .toList(),
