...
class AppLocalizations {
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'account_benefits': 'Why do you need an account?',
      'benefit_history': 'Save search history and favorite words',
      'benefit_features': 'Sync learning progress across all devices',
      ...
      'dictionary_empty_subtitle': 'Discover meanings, examples, and more',
      ...
      'translation_history_title': 'Translation History',
      ...
      'guessing_menu_description': 'Guess the word using hints and definitions',
      'flashcard_header_title': 'Flashcards',
      'flashcard_progress_label': 'Card {current} of {total}',
      'flashcard_skip': 'Skip',
      'flashcard_save': 'Save',
      'flashcard_known': 'I know this word',
      'flashcard_dialog_perfect_title': 'Amazing!',
      'flashcard_dialog_try_title': 'Keep trying!',
      'flashcard_dialog_try_body': 'You need to practice more.',
      'flashcard_dialog_good_title': 'Great job!',
      'flashcard_dialog_good_body': 'You know {known}/{total} words.',
      ...
      'flashcard_saved_word': 'Saved "{word}" to dictionary',
      'flashcard_login_required': 'Please log in to save words',
      'flashcard_translated_label': 'Translated to Vietnamese',
      'flashcard_translate_error': 'Unable to translate this text',
      'flashcard_translate_failed': 'Translation error: {error}',
      'matching_header_title': 'Matching',
      'matching_dialog_title': 'Great effort!',
      'matching_dialog_subtitle': 'You matched everything correctly!',
      ...
      'matching_select_words_title': 'Choose words to save',
      ...
      'guessing_hint_used_plural': 'Used {count} hints',
      'guessing_input_placeholder': 'Enter your answer...',
      ...
      'guessing_correct_answer': 'Correct answer: {word}',
      ...
      'guessing_translate_error': 'Unable to translate. Please try again.',
      // About screen
    ...
    'vi': {
      ...
      'benefit_history': 'Lưu lịch sử sử tra cứu và từ yêu thích',
      ...
      'dictionary_empty_subtitle': 'Khám phá nghĩa, ví dụ và nhiều hơn nữa',
      ...
      'enter_text_to_translate': 'Vui lòng nhập văn bản để dịch',
      'translation_failed_error': 'Dịch thất bại: {error}',
      // Game screen
      'word_guess': 'Đoán chữ',
      ...
      'matching_menu_description': 'Ghép từ tiếng Anh với nghĩa tiếng Việt',
      'guessing_menu_title': 'Đoán từ',
      'guessing_menu_description': 'Đoán từ dựa trên gợi ý và định nghĩa',
      'flashcard_header_title': 'Thẻ ghi nhớ',
      'flashcard_progress_label': 'Thẻ {current} trong số {total}',
      ...
      'flashcard_dialog_try_body': 'Bạn phải cố gắng nhiều hơn.',
      'flashcard_dialog_good_title': 'Chúc mừng!',
      'flashcard_dialog_good_body': 'Bạn đã biết {known}/{total} từ.',
      ...
      'flashcard_saved_word': 'Đã lưu "{word}" vào từ điển',
      'flashcard_login_required': 'Vui lòng đăng nhập để lưu từ',
      'flashcard_translated_label': 'Đã dịch sang Tiếng Việt',
      'flashcard_translate_error': 'Không thể dịch văn bản này',
      'flashcard_translate_failed': 'Lỗi khi dịch: {error}',
      'matching_header_title': 'Ghép từ',
      'matching_dialog_title': 'Cố gắng lên!',
      'matching_dialog_subtitle': 'Bạn đã ghép đúng tất cả!',
      ...
      'guessing_hint_used_plural': 'Đã dùng {count} gợi ý',
      'guessing_input_placeholder': 'Nhập đáp án của bạn...',
      ...
      'guessing_translate_error': 'Không thể dịch. Vui lòng thử lại.',
      // About screen
